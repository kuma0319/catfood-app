...
ActiveRecord::Schema[7.0].define(version: 2023_08_18_042129) do
  ...
  create_table "evaluations", force: :cascade do |t|
    ...
    t.index ["review_item_id", "review_id"], name: "index_evaluations_on_review_item_id_and_review_id", unique: true
