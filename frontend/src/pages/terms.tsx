...
const Terms = () => {
  const meta_title = "ねこまんま | 利用規約";
  const meta_description = "ねこまんまの利用規約ページです。";
  const meta_url = "https://www.nekomanmafood.com/terms";
  return (
    <>
      <CommonMeta
        title={meta_title}
        ...
        <div className={noto_jp.className}>
          <div className="mx-auto max-w-screen-md p-4 text-sm">
            ...
            <p className="mb-6 text-gray-700">
              この利用規約（以下，「本規約」といいます。）は，サイト運営者（以下，「当方」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
            </p>
            ...
            <p className="mb-4 text-gray-700">
              <ol className="list-inside list-decimal pl-5">
                ...
                <li>
                  ユーザーは，いかなる場合にも，メールアドレスおよびパスワードを第三者に譲渡または貸与し，もしくは第三者と共用することはできません。当方は，メールアドレスとパスワードの組み合わせが登録情報と一致してログインされた場合には，そのメールアドレスを登録しているユーザー自身による利用とみなします。
                </li>
                <li>
                  メールアドレス及びパスワードが第三者によって使用されたことによって生じた損害は，当方に故意又は重大な過失がある場合を除き，当方は一切の責任を負わないものとします。
                </li>
              </ol>
            </p>
            <h2 className="mb-2 mt-4 text-base font-semibold text-gray-800">
            ...
            <p className="mb-4 text-gray-700">
              ...
              <ol className="list-inside list-decimal pl-5">
                ...
                <li>
                  本サービスの提供するデータや情報を，スクレイピング，クローリング，またはその他の方法で不正に取得する行為
                </li>
